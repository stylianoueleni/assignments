...
/**
 * Write a description of class ZeroInDegreeTopologicalSortWithPriorityQueue here.
 *
 * Ελένη Στυλιανού
 * ge21708
 * 11/2024
...
public class ZeroInDegreeTopologicalSortWithPriorityQueue {
    private int vertices; // Αριθμός κορυφών
    private LinkedList<Integer> adjList[]; // Λίστα γειτνίασης

    // Κατασκευαστής
    public ZeroInDegreeTopologicalSortWithPriorityQueue(int v) {
        vertices = v;
    ...
    // Συνάρτηση που υπολογίζει την τοπολογική διάταξη με χρήση ουράς προτεραιότητας
    public void zeroInDegreeTopologicalSort() {
        ...
        // Δημιουργία ουράς προτεραιότητας για τις κορυφές με εσωβαθμό 0
        PriorityQueue<Integer> zeroInDegreeQueue = new PriorityQueue<>();

        // Προσθήκη όλων των κορυφών με εσωβαθμό 0 στην ουρά προτεραιότητας
        for (int i = 0; i < vertices; i++) {
            if (inDegree[i] == 0) {
        ...
        while (!zeroInDegreeQueue.isEmpty()) {
            // Επιλογή κορυφής με τον μικρότερο αριθμό (βάσει ουράς προτεραιότητας)
    ...
    public static void main(String args[]) {
        ZeroInDegreeTopologicalSortWithPriorityQueue graph = new ZeroInDegreeTopologicalSortWithPriorityQueue(6);
        graph.addEdge(5, 2);
        graph.addEdge(5, 0);
        graph.addEdge(4, 0);
        graph.addEdge(4, 1);
